# rfid/test_rft_single_buzzer.py
"""
تست RFT-23x با بوق یک بار هنگام شناسایی کارت
"""
...
def buzzer(beep_time=3, addr=ADDR):
    ...
    beep_time: زمان بوق به واحد 10ms (پیش‌فرض 3 = 30ms)
    """
...
def main():
    print("=" * 60)
    print("🧪 تست RFT-23x با بوق یک بار")
    print("=" * 60)
